...
Самый быстрый способ! Просто запустите:
...
📖 Подробнее: [Docker Quick Start Guide](./DOCKER_QUICKSTART.md) | [Полная документация по Docker](./DOCKER_GUIDE.md)

**Вариант 2: Локальная установка 💻**

Следуйте шагам ниже для установки без Docker.
